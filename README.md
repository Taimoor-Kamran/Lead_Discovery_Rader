...
> **Evaluating the product on a Windows PC?** Skip everything else and follow
> [README-WINDOWS.md](README-WINDOWS.md): from a clean PC to a review queue with real
> businesses in it.
...
## Evaluating on Windows

The Windows guide lives in its own document, [README-WINDOWS.md](README-WINDOWS.md). It
runs everything inside WSL2 Ubuntu with the same `make` targets as above (spec v0.11.2
explains why there is no PowerShell route).
